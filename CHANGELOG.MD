...
- **Orchestrator (parallel path):** `_run_agents_parallel_batch` stages **all** compute-phase logs and commit-phase `apply.jsonl` entries, then performs a single **ordered flush**.
