...
## [Unreleased]
**Summary:** PR98 + PR99 land the Python FFI surface, strict‑parity harness, and the first Rust kernel (perf‑OFF semantics; optional; identity‑safe by default).
...
- **PR100:** Wheels/CI matrix; installed-wheel tests.
